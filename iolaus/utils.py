...
# valid option keys
FIELD_TYPES = {
    "positions": "Iolaus.fields:Positions",
    "shears": "Iolaus.fields:Shears",
    "visibility": "Iolaus.fields:Visibility",
    "weights": "Iolaus.fields:Weights",
}
...
def main():
    """Main method of the `Iolaus` command.
